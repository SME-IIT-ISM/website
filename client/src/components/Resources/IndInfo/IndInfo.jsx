...
const infoData = [
  {
    ...
    date:"JUNE 2021",
    quotes:"The index of mineral manufacturing of mining and quarrying sector fell by 7.8 per cent throughout the monetary 12 months 2020-21.",
    describe:`There was a fall of 7.8 percent in the index of mineral manufacturing of the mining and quarrying sector throughout the monetary 12 months 2020- 21.
There was a 6.1 percent increase for march whereas there was a 5.5 percent decrease for february in the index.
    
    There was a growth in manufacturing of manganese ore, chromite, phosphorite, lead focus, copper focus, throughout the February- march interval on the other hand manufacturing of magnesite, zinc conc.Pure Fuel (utilized) and coal additionally grew year-on-year throughout March.

    There was an increase in manufacturing of chromite by 70.5per cent,in february and 45.8percent in march making it to 6.01 tonnes while the increase in phosphorite ore's production was 24.5 per cent in february and 57 per cent in march making it 1.33 lakh tonnes.`,
    class: "latest",
  },
  {
    src: Info1,
    para: "VOL. 11",
    date:"JUNE 2021",
    title: "The market of EV IS expected to have substantial impact on copper demand.",
    quotes:"The index of mineral manufacturing of mining and quarrying sector fell by 7.8 per cent throughout the monetary 12 months 2020-21.",
    describe:`The Centre has announced a new scheme of scrap

    recycling of non-ferrous metals like aluminium and copper to reduce scrap imports. According to the mines ministry,
    
    underdeveloped metal scrap collection, segregation, and processing infrastructure in the market have led the non-ferrous metal industry. to be highly dependent on imports. They said that this new framework (2020) will use a life cycle management approach for better efficiency in the mineral value chain process. This framework will focus on both product and processing stewardship. The demand and production of aluminium both have increased at CAGR of 6.77% and 11.19% respectively.
    
    This growing demand will also enhance the
  ...
  },
  {
    ...
    para: "VOL. 9",
    date:"MAY 2021",
    title: "Second tranche of Indian commercial coal mining auction gets soaring attraction from bidders",
    quotes:"For the first time 67 mines are up for bidding in single tranche since 2014",
    describe:`The second tranche of

    Ministry of Mines and Minerals Coal Mines Act covers 44.The way for the liberalization of the Indian coal sector by increasing limited and extensive deposits, and fully and partially explored
  ...
  },
  {
    ...
    para: "VOL. 4",
    date:"MARCH 2021",
    title: "Government elucidate and pronounced to execute newly rectified mining laws",
    quotes:"Better Laws For Better Mining",
    describe:`In the cabinet meeting, the Indian government has reformed the mining law to remove restrictive end-use conditions on confined mines and resolve legacy issues by exploring more shots for auction. The structural modifications in the mining sectors have been approved through amendments to the MMDR Act(1957). These changes will affect minerals like gold, diamond, platinum etc. bringing about prodigious investment. The reformation will allow captive mines to sell up to half of their minerals excavated annually, minimizing the divergence

    between the merchant and captive mines. Section 10A(2) (b) and 10A(2)(c) deal with prevailing leases where surveillance permits and grants of a lease to resolve legacy issues of mines through auctions respectively. Those who proposed to transfer non auctioned mines to the willing will not have any charges imposed on them. Several other reforms approved by the cabinet include a proper license for production and exploration, refrained double taxation, transparency in illegal mining, and utilization of regional mineral funds.`,
    class: "old",
  },
  {
    src: Info10,
  ...
  },
  {
    ...
    describe:"While COVID 19 pandemic Mining industry has already has hampered the sale of mining equipment, it is being driving trucks, autonomous credited to drive the demand blast drills, loaders and of Autonomous Driving remote operation of load Technology adopted technologies for self haul-dump machinery. Now, Caterpillar has seen double- the occurrence of lockdowns digit percentage increase in its sale of autonomous mining technology in 2020 as compared to 2019. Fred Rio (Caterpillar's product manager) has told that remote control tech would be available for construction sites in January. The company is also working with Space Agencies to make the intercontinental remote control of machines possible. has accelerated their deployment. Caterpillar & Komatsu hold a large share of global autonomous haulage systems. Caterpillar here has an advantage, as its technology can be retrofitted onto competitor's equipment. Whereas, Komatsu is being reported to develop technology that would allow equipments of different brands to operate together 'safely and efficiently'.",
    class: "old",
  }
];
